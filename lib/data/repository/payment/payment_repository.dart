...
abstract class PaymentRepository {
  Future<Result<String>> paymentPreRequest(String authJWT, String type, int amount, String currency, bool iap, String iapProvider, bool trial, int trialDays, int productionIdx);
