...
class PaymentProviderModel extends ProviderModel<PaymentProviderState> {
  ...
  Future<void> paymentPreRequest(String authJWT, String type, int amount, String currency, bool iap, String iapProvider, bool trial, int productionIdx) async {
    final paymentPreRequest = _paymentRepository.paymentPreRequest(authJWT, type, amount, currency, iap, iapProvider, trial, productionIdx);
