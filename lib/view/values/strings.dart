class Strings {
  ...
  static const String sign_up_terms_info = '개인정보 수집 및 이용';
  static const String sign_up_terms_essential = ' (필수)';
  static const String sign_up_terms_script = '이용약관, 개인정보 수집 및 이용에 동의하시면 확인 버튼을 눌러주세요.';
  static const String sign_up_terms_marketing = '마케팅 정보 알림 메일 수신 (선택)';
  ...
  static const String mypage_setting_update = '업데이트 하기';
  static const String mypage_setting_sound = '사운드 설정';
  static const String mypage_setting_voice ='음성';
  ...
  static const String mypage_help_script = '찾으시는 답변이 없다면, 카카오톡 바름드끼 상담봇에게 물어봐주세요.\n단, 상담원 채팅은 근무시간 내에만 답변 가능합니다. (평일 AM 10:00 ~ PM 06:00)';
}